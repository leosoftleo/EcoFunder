...
class RNewsListItem extends StatelessWidget {
  RNewsListItem(this.data);
            ...
            child: Stack(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(data.title, maxLines: 2, overflow: TextOverflow.ellipsis, style: SNews.CARD_TITLE_TEXT_TS,),
                )
              ],
            ),
          ),
